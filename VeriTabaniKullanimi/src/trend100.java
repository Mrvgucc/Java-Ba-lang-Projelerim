 ...
 * @author Merve
 */
public class trend100 extends javax.swing.JFrame {

    Baglanti vt;
    String mail;

    public trend100(String mail) {
        initComponents();
        vt = new Baglanti();
        String[][] sikayetler = vt.begeniSirasi();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Ad", "Soyad", "Şikayet", "Şİkayet Tarihi", "Beğeni Sayısı"
            }
        ) {
        ...
        jTable1.setToolTipText("Beğenmek için tıklayın");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(trend100.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new trend100("Test").setVisible(true);
            }
        });
    }
